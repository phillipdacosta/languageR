...
// Re-export `verifyToken` from the new dedicated auth middleware so all
// existing import sites (`require('../middleware/videoUploadMiddleware')`)
// keep working without changes. The new file enforces Auth0 JWT signature
// verification and gates dev tokens behind ALLOW_DEV_TOKENS / NODE_ENV.
