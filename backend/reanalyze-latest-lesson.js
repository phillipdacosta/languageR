...
async function reanalyzeLesson() {
  try {
    ...
    // Get the most recent completed lesson transcript
    const lessonId = '692e00c1d780ecd16c06c134';
    ...
    console.log('\n✅ Analysis updated successfully! Students will now see the enhanced version.');
